...
namespace ECommerce.Migrations
{
    ...
    [Migration("20250515062700_TbPageTable")]
    partial class TbPageTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.TbPage", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("ECommerce.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECommerce.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("ECommerce.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("ECommerce.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("ECommerce.Models.TbItem", b =>
                {
                    b.HasOne("ECommerce.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("ECommerce.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                    ...
                    b.HasOne("ECommerce.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ECommerce.Models.TbItemDiscount", b =>
                {
                    b.HasOne("ECommerce.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("ECommerce.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("ECommerce.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("ECommerce.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("ECommerce.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("ECommerce.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("ECommerce.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("ECommerce.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
